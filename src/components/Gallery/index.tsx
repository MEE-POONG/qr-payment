                    ...
                    <div key={img.id} className="p-1 md:p-2 relative" style={{ width: img.w, height: img.h }}>
                        ...
                        <label htmlFor={`photo-${selectedTemplate.tem}-${imgIndex}`} className="block w-full h-full cursor-pointer">
                            ...
                            <img
                                ...
                                src={mode === 'edit' ?
                                    (selectedImages[imgIndex] || "https://imagedelivery.net/QZ6TuL-3r02W7wQjQrv5DA/f701ce08-7ebe-4af2-c4ec-2b3967392900/350") :
                                    `https://imagedelivery.net/QZ6TuL-3r02W7wQjQrv5DA/${selectedImages[imgIndex]}/wmdfa`}
                            />
                        </label>
                    </div>
                ))}
